...
function LandSearchFilter({ onFilter }) {
  ...
  return (
    <form onSubmit={handleSearch} className="mb-8 rounded-3xl bg-white/80 p-5 shadow-lg backdrop-blur">
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-gray-800">
          Find Your Perfect Land
        </h2>
        <p className="text-sm text-gray-500">
          Search and filter available lands for lease
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <input
          type="text"
          placeholder="📍 Location (e.g. Thrissur)"
          value={location}
